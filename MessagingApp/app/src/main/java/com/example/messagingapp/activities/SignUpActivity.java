...
public class SignUpActivity extends AppCompatActivity {
    ...
    // Set click listeners for buttons, image selection, and signing up
    ...
    // Activity result launcher for picking an image from the gallery for the profile pic
    ...
    // Show or hide loading indicators based on the loading state
