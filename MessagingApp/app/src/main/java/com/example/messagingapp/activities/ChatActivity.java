...
public class ChatActivity extends AppCompatActivity {
    ...
    // Initialize variables and set up the chat adapter
    private void init(){
    ...
    // Send a chat message to the Firebase database
    ...
    // Listen for incoming chat messages from Firebase
    ...
    // Event listener to handle Firebase snapshot changes
    ...
    // Load details of the chat receiver user
    private void loadReceiverDetails(){
        receiverUser = (User)getIntent().getSerializableExtra(Constants.KEY_USER);
        binding.textName.setText(receiverUser.name);
    }

    // Set click listeners for back button and send message button
    private void setListeners(){
        binding.imageBack.setOnClickListener(v -> finish());
        binding.layoutSend.setOnClickListener(v -> sendMessage());
    }

    // Format the given date to a readable date and time
